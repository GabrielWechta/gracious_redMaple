...
_lr_productions = [
  ...
  ('program -> DECLARE declarations BEGIN commands END','program',5,'p_program','parser.py',65),
  ('program -> BEGIN commands END','program',3,'p_program','parser.py',66),
  ('declarations -> declarations COMMA PIDENTIFIER','declarations',3,'p_declarations','parser.py',75),
  ('declarations -> declarations COMMA PIDENTIFIER LPAREN NUM COLON NUM RPAREN','declarations',8,'p_declarations','parser.py',76),
  ('declarations -> PIDENTIFIER','declarations',1,'p_declarations','parser.py',77),
  ('declarations -> PIDENTIFIER LPAREN NUM COLON NUM RPAREN','declarations',6,'p_declarations','parser.py',78),
  ('commands -> commands command','commands',2,'p_commands','parser.py',91),
  ('commands -> command','commands',1,'p_commands','parser.py',92),
  ('command -> identifier ASSGNOP expression SEMICOLON','command',4,'p_command','parser.py',105),
  ('command -> IF condition THEN commands ELSE commands ENDIF','command',7,'p_command','parser.py',106),
  ('command -> IF condition THEN commands ENDIF','command',5,'p_command','parser.py',107),
  ('command -> WHILE condition DO commands ENDWHILE','command',5,'p_command','parser.py',108),
  ('command -> REPEAT commands UNTIL condition SEMICOLON','command',5,'p_command','parser.py',109),
  ('command -> FOR PIDENTIFIER FROM value TO value DO commands ENDFOR','command',9,'p_command','parser.py',110),
  ('command -> FOR PIDENTIFIER FROM value DOWNTO value DO commands ENDFOR','command',9,'p_command','parser.py',111),
  ('command -> READ identifier SEMICOLON','command',3,'p_command','parser.py',112),
  ('command -> WRITE value SEMICOLON','command',3,'p_command','parser.py',113),
  ('expression -> value','expression',1,'p_expression','parser.py',136),
  ('expression -> value PLUS value','expression',3,'p_expression','parser.py',137),
  ('expression -> value MINUS value','expression',3,'p_expression','parser.py',138),
  ('expression -> value TIMES value','expression',3,'p_expression','parser.py',139),
  ('expression -> value DIVIDE value','expression',3,'p_expression','parser.py',140),
  ('expression -> value MODULO value','expression',3,'p_expression','parser.py',141),
  ('condition -> value EQUAL value','condition',3,'p_condition','parser.py',158),
  ('condition -> value NOTEQUAL value','condition',3,'p_condition','parser.py',159),
  ('condition -> value LESSER value','condition',3,'p_condition','parser.py',160),
  ('condition -> value BIGGER value','condition',3,'p_condition','parser.py',161),
  ('condition -> value LESSEREQUAL value','condition',3,'p_condition','parser.py',162),
  ('condition -> value BIGGEREQUAL value','condition',3,'p_condition','parser.py',163),
  ('value -> NUM','value',1,'p_value_num','parser.py',180),
  ('value -> identifier','value',1,'p_value_identifier','parser.py',185),
  ('identifier -> PIDENTIFIER','identifier',1,'p_identifier_pidentifier','parser.py',190),
  ('identifier -> PIDENTIFIER LPAREN PIDENTIFIER RPAREN','identifier',4,'p_identifier_pidentifier','parser.py',191),
  ('identifier -> PIDENTIFIER LPAREN NUM RPAREN','identifier',4,'p_identifier_pidentifier','parser.py',192),
]
